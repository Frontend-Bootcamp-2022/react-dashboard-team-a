...
function CardInfo(props){
    ...
    <Title title={props.title} />
        ...
        <Info date={props.date} status={props.status} statusDot={statusDot} className={className}
        cardData={cardData} tasks={props.tasks} users={props.users} infoStatus={infoStatus} statusText={status}/>
